  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="space-y-6 text-sm text-gray-400 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">Tokens & Payments</h2>
          <ul className="list-disc ml-5 space-y-1">
            <li>Tokens are used to access AI features (resume tailoring, cover letter generation)</li>
            <li>Free features (ATS scoring, diff tool, keyword checker, editor, stash) do not require tokens</li>
        ...
        <section>
          ...
          <p>You own your resume content. We do not claim any rights to the text you input or the AI-generated output. You grant us a limited license to process your content solely for the purpose of providing the service.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-white mb-2">AI Output</h2>
          <p>AI-generated content is provided as-is. We do not guarantee that tailored resumes will result in interviews or job offers. Always review AI suggestions before submitting applications. Do not include false information in your resume.</p>
        </section>
        ...
        <section>
          ...
          <p>We aim for high availability but do not guarantee uninterrupted service. AI providers may experience outages. If a generation fails, your token is refunded automatically.</p>
        </section>
