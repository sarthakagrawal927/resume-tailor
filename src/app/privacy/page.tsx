  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="space-y-6 text-sm text-gray-400 leading-relaxed">
        <p className="text-gray-300">Last updated: March 16, 2026</p>
        ...
        <section>
          ...
          <ul className="list-disc ml-5 mt-2 space-y-1">
            ...
            <li><strong className="text-gray-300">Job descriptions:</strong> URLs and text you provide for tailoring</li>
            <li><strong className="text-gray-300">Payment data:</strong> Processed by Dodo Payments — we never see your card details</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc ml-5 space-y-1">
            <li>Resume and job description text is sent to Google Gemini API to generate tailored versions</li>
        ...
        <section>
          ...
          <p>Your data is stored in Turso (distributed SQLite) with encryption at rest. We use Vercel for hosting with edge-level TLS encryption.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-white mb-2">Data Deletion</h2>
          <p>You can delete your resumes, job applications, and account at any time. To request full data deletion, contact us at the email below.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-white mb-2">Third Parties</h2>
          <ul className="list-disc ml-5 space-y-1">
            <li><strong className="text-gray-300">Google Gemini:</strong> Processes resume/JD text for AI tailoring</li>
            <li><strong className="text-gray-300">Dodo Payments:</strong> Handles payment processing</li>
            <li><strong className="text-gray-300">Google Auth:</strong> Handles sign-in</li>
            <li><strong className="text-gray-300">Vercel:</strong> Hosting and edge delivery</li>
            <li><strong className="text-gray-300">Turso:</strong> Database</li>
          </ul>
        </section>
